...
urlpatterns = [
    ...
    path('make-captain/<uuid:id_pemain>',make_captain, name='make_captain'),
    path('remove_player/<uuid:id_pemain>',remove_player, name='remove_player'),
    path('remove_coach/<uuid:id_pelatih>',remove_coach,name='remove_coach'),
